const BUILD_AUDIT_RULES={
 ...
 break:['部位を狙って命中','部位破壊力×1.3。武器種・強攻撃倍率・装備固定値を別途適用。破壊素材抽選8%→22%、特定部位は敵ATK/DEF低下。強攻撃では敵DEF-3も適用','partBreakPower / hitEnemyPart / partRewardRolls'],
